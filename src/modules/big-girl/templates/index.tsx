...
// import BigGirlBirthday from "../big-girl-birthday"
...
import AboutSection from "../v2components/about"
...
export default async function GirlBigGirlTemplate({
  events,
}: {
  events: Event[]
}) {
  ...
  return (
    <div className="">
      ...
      <Benefits />
      <BigGirlBirthday />
      <div className="mx-4 -mt-40 max-w-5xl rounded-[60px] bg-white pt-12 md:mx-auto md:-mt-40">
        <InfoBlock
          imgSrc={[
            "/images/girls/big-girl/bottles.jpg",
            "/images/girls/big-girl/mom.jpg",
            "/images/girls/big-girl/team.jpg",
          ]}
        >
          <div className="">
            <h1 className="font-jost text-[40px]/10 font-normal tracking-tight text-black">
              <span className="font-literature text-xl font-medium text-[#2E4F6C] md:text-3xl">
      ...
      {/* <BigGirlBirthday /> */}
      <div className="mx-4 mt-20 max-w-5xl rounded-[60px] bg-white pt-12 md:mx-auto md:mt-20">
        <InfoBlock
          imgSrc={[
