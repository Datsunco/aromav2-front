...
const data = {
  ...
  introParagraphs: [
    "Матрица Судьбы - это карта судьбы человека. Всё есть энергия. И человек -  набор энергий. Ключ к пониманию, код человека - дата рождения.",
  ],
  ...
  images: {
    teaPouring: "/images/numerology/needle.jpg", // <- Укажите свой путь
