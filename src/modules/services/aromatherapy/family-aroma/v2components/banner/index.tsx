  ...
  return (
    <section className="relative mx-[22px] mt-[18px] rounded-[30px] bg-blue-origin/[77] py-4 shadow-[inset_9px_9px_26.4px_0_#2437E21A] md:mx-[25px] md:mt-[40px] md:rounded-[40px] md:py-6 md:shadow-[inset_6.1px_6.1px_17.89px_0_#2437E21A]">
      ...
      <Image
        ...
        width={160}
        height={160}
        className="absolute bottom-20 left-1/2 z-0 w-full -translate-x-1/2 p-6 opacity-50 blur-[1px] md:bottom-14 md:left-auto md:right-8 md:h-[184px] md:w-[275px] md:translate-x-0 md:p-0 md:opacity-100 md:blur-0 xl:bottom-10 xl:right-20 xl:h-[263px] xl:w-[395px]"
