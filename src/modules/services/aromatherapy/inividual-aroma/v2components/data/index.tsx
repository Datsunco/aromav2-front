...
const INFO_BLOCKS_DATA: InfoBlockProps[] = [
  {
    title: "Для полного раскрытия энергии необходимо 3 сеанса",
    description:
      "После 3 ароматестирования ваш организм почувствует себя в ресурсе и начнёт раскрывать ваши грани, ваши таланты, вашу уникальность.",
    image: {
  ...
  {
    title: "Что вы получите после первого сеанса",
    description: [
      "80 ароматов эфирных масел",
      "2 часа наслаждения и расслабления",
      "Флакончик индивидуальных ресурсных духов",
      "Комплект кремов для тела",
    ],
    image: {
      src: "/images/lavanda2.png", // Укажите свой путь
      alt: "Флакон с маслом",
